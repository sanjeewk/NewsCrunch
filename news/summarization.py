...
class Summariser:
    def __init__(self):
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained("sshleifer/distilbart-cnn-12-6")  # "EleutherAI/gpt-j-6B"
        # self.model = BartForConditionalGeneration.from_pretrained("sshleifer/distilbart-cnn-12-6")  # "EleutherAI/gpt-j-6B"
